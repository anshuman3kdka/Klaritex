  ...
  return (
    <div>
      ...
      <div
        ...
        aria-describedby={`klaritex-pdf-desc ${activeErrorMessage ? "klaritex-pdf-error" : ""}`.trim()}
      >
        <p className="font-ui font-medium">Drag and drop a PDF here, or click to choose a file</p>
        <p id="klaritex-pdf-desc" className="font-ui mt-1 text-xs text-[var(--text-secondary)]">PDF only · Maximum 5MB</p>
