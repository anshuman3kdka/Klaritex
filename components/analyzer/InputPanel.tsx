          ...
          {inputMode === "text" ? (
            <>
              ...
              <textarea
                ...
                aria-invalid={!!(errorMessage && inputMode === "text")}
                aria-describedby={errorMessage && inputMode === "text" ? "klaritex-text-hint klaritex-text-error" : "klaritex-text-hint"}
              ...
              />
              <p id="klaritex-text-hint" className={`font-mono-ui mt-2 text-sm ${isNearLimit ? "text-[var(--tier2-color)]" : "text-[var(--text-secondary)]"}`}>
