...
function hasExpectedShape(payload) {
  ...
  if (
    ...
    Object.prototype.hasOwnProperty.call(objectPayload, "status") ||
    Object.prototype.hasOwnProperty.call(objectPayload, "message")
  ) {
    return true;
  }

  // Klaritex-specific fallback shape on successful analysis responses.
  return (
    Object.prototype.hasOwnProperty.call(objectPayload, "ambiguityScore") &&
    Object.prototype.hasOwnProperty.call(objectPayload, "elements")
  );
}
...
async function timedRequest(name, makeRequest) {
  ...
  if (!hasExpectedShape(payload)) {
    return {
      ...
      statusCode: response.status,
      elapsedMs,
      reason: "Missing expected fields (result/status/message or analysis fields)",
    };
  }
