...
export default function HomePage() {
  return (
    <div className="flex h-[100dvh] flex-col bg-[var(--bg-primary)]">
      ...
      <footer className="shrink-0 border-t border-[var(--border)] bg-[var(--bg-surface)]/50">
        <div className="mx-auto flex flex-col w-full max-w-6xl gap-4 px-4 py-10 sm:px-6">
          ...
          <div className="font-ui text-sm text-[var(--text-secondary)] sm:text-base">
