  ...
  return (
    <main id="main-content" className="min-h-screen bg-[var(--lab-surface)] px-6 py-10 text-[var(--lab-ink)] md:px-10">
      <article className="mx-auto max-w-3xl space-y-6">
        ...
        <div
          className="max-w-none space-y-4 font-sans text-sm leading-[1.7] text-[var(--lab-ink)] [&_a]:text-[var(--lab-ink)] [&_a]:underline [&_a:hover]:text-[var(--lab-gold)] [&_blockquote]:rounded-[8px] [&_blockquote]:bg-[var(--lab-surface)] [&_blockquote]:shadow-[inset_4px_4px_8px_var(--lab-shadow-dark),inset_-4px_-4px_8px_var(--lab-shadow-light)] [&_blockquote]:px-4 [&_blockquote]:py-3 [&_blockquote]:italic [&_blockquote]:opacity-90 [&_code]:rounded [&_code]:bg-[var(--lab-shadow-dark)]/20 [&_code]:px-1.5 [&_code]:py-0.5 [&_h1]:mt-10 [&_h1]:font-serif [&_h1]:text-4xl [&_h1]:leading-tight [&_h1]:font-semibold [&_h2]:mt-10 [&_h2]:font-serif [&_h2]:text-3xl [&_h2]:leading-tight [&_h2]:font-semibold [&_h3]:mt-8 [&_h3]:font-serif [&_h3]:text-2xl [&_h3]:leading-snug [&_h3]:font-semibold [&_hr]:h-px [&_hr]:border-0 [&_hr]:bg-[var(--lab-shadow-dark)]/45 [&_li]:mt-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:leading-[1.7] [&_p]:text-[var(--lab-ink)] [&_pre]:overflow-x-auto [&_pre]:rounded-[8px] [&_pre]:bg-[var(--lab-surface)] [&_pre]:shadow-[var(--shadow-pressed)] [&_pre]:p-4 [&_pre]:text-xs [&_pre]:font-mono [&_ul]:list-disc [&_ul]:pl-6"
